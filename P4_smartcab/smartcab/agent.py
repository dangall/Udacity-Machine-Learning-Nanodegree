...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        # zzzzzz DELETE THESE COMMENTS
        #stateQvalues = self.Q[state].values()
        #if stateQvalues!=[]:
        #    maxQ = max(stateQvalues)
        #else:
        #    maxQ = 0.0
    ...
    def createQ(self, state):
        ...
        if state not in (self.Q).keys():
            new_action_dict = {act: 0.0 for act in self.valid_actions}
            old_Q_dict = self.Q
    ...
    def learn(self, state, action, reward):
        ...
        # In other words, we pretend here that the discount factor gamma equals zero
